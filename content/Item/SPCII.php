...
class SPCII extends WebDispatch 
{
    ...
    public function body_content()
    {
        ...
        $td3 = "";
            ...
            foreach ($missing as $upcs) {
                ...
                $missingLane[] = $this->checkLaneSales($upcs1, 1, '10.11.11.22');
                $missingLane[] = $this->checkLaneSales($upcs1, 1, '10.11.11.23');
                $missingLane[] = $this->checkLaneSales($upcs1, 1, '10.11.11.24');
                $missingLane[] = $this->checkLaneSales($upcs1, 1, '10.11.11.25');
                $missingLane[] = $this->checkLaneSales($upcs1, 1, '10.11.11.26');
                ...
                unset($missingLane);
                $missingLane[] = $this->checkLaneSales($upcs2, 2, '10.22.22.12');
                $missingLane[] = $this->checkLaneSales($upcs2, 2, '10.22.22.13');
                $missingLane[] = $this->checkLaneSales($upcs2, 2, '10.22.22.14');
                $missingLane[] = $this->checkLaneSales($upcs2, 2, '10.22.22.15');
                foreach ($missingLane as $upcs) {
                    foreach ($upcs as $upc => $stores) {
                        foreach ($stores as $storeID => $v) {
                            $td3 .= "<tr>";
        ...
        return <<<HTML
<h4>Unforced/Unsynced Sales found on SERVER</h4>
<table class="table table-bordered table-sm small">
    <thead><th>upc</th><th>storeID</th><th>sale price</th><th>batchID</th><th>brand</th><th>description</th></thead>
    <tbody>$td1</tbody>
</table>
<h4>Unforced/Unsynced Sales found on Hillside POS Lanes</h4>
<table class="table table-bordered table-sm small">
    <thead><th>upc</th><th>storeID</th><th>sale price</th><th>batchID</th><th>brand</th><th>description</th></thead>
    <tbody>$td2</tbody>
</table>
<h4>Unforced/Unsynced Sales found on Denfeld POS Lanes</h4>
<table class="table table-bordered table-sm small">
<table class="table table-bordered table-sm small">
    <thead><th>upc</th><th>storeID</th><th>sale price</th><th>batchID</th><th>brand</th><th>description</th></thead>
    <tbody>$td3</tbody>
