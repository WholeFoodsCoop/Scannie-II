...
JAVASCRIPT;
                ...
                echo "<br /><br /><div align='center'><div class='alert alert-danger login-resp' style='max-width: 90vw;'>Username or Password is incorrect</div></div>";
            }
        }
        ...
        $ret .= '
            <div class="login-form" align="center" style="'.$width.'">
                <form method="post" class="form-inline">
                    <h2 class="login"><a href="http://'.$MY_ROOTDIR.'" title="Back to Home Page">SV2.0 Login</a></h2><br /><br />
